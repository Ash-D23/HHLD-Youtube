           ...
           <div className='w-1/3 relative'>
                <div class="flex min-w-full">
                    <div class="relative w-full">
                        <input value={searchText} onChange={(e) => setSearchText(e.target.value)} type="search" id="search-dropdown" class="block p-2 pl-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-lg bg-gray-700 border-0 text-white outline-none" placeholder="Search" required />
                        <button type="submit" class="absolute top-0 end-0 p-2 text-sm font-medium h-full text-white bg-gray-700 rounded-e-lg border border-2 border-gray-700 hover:bg-gray-800 bg-gray-700 hover:bg-gray-800">
