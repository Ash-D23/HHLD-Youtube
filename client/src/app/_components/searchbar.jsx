           ...
           <div className='w-1/3 relative'>
                <div class="flex min-w-full">
                    <div class="relative w-full">
                        <input value={searchText} onChange={(e) => setSearchText(e.target.value)} type="search" id="search-dropdown" class="block p-2 pl-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-lg dark:bg-gray-700 border-0 dark:text-white outline-none" placeholder="Search" required />
