    ...
    <div className='bg-gray-800 home-height w-screen flex justify-center items-center'>
        <div className='w-3/5 shadow p-4 flex justify-center items-center flex-col'>
            ...
            <div className='flex justify-center items-center ml-8'>
                <button onClick={loginHandler} type="button" class="text-white font-semibold rounded-lg  px-4 py-2 me-2 mb-2 dark:bg-blue-600 hover:bg-blue-700 focus:outline-none ">Login</button>
            </div>
        </div>
    </div>
  )
